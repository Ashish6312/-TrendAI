...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-[#020617] dark:via-[#0f172a] dark:to-[#1e1b4b] selection:bg-blue-500/30 overflow-x-hidden min-h-screen transition-colors duration-500">
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              >
                {[
                  { label: t("feat_title"), href: "#features" },
                  { label: t("road_directive"), href: "#business-plan" },
                  { label: t("home_trusted"), href: "#testimonials" }
                ].map((link, idx) => (
                  <a
                    key={idx}
                    href={link.href}
        ...
        <div className="grid lg:grid-cols-2 compact-gap-6 items-center">
          ...
          >
            <div className="inline-flex items-center compact-gap-2 compact-p-3 rounded-full bg-emerald-500/15 dark:bg-emerald-500/10 border border-emerald-500/30 dark:border-emerald-500/20 compact-text-xs font-black text-emerald-600 dark:text-emerald-400 tracking-[0.3em] uppercase shadow-lg">
              <Globe2 size={12} /> {t("home_live_data").toUpperCase()}
            </div>
            <div className="relative z-10 text-center compact-space-y-4">
              <h2 className="compact-text-3xl sm:compact-text-5xl font-black text-slate-900 dark:text-white tracking-tighter leading-[0.85] drop-shadow-sm">
                {t("banner_title")}
              </h2>
              <p className="text-slate-600 dark:text-slate-300 compact-text-base sm:compact-text-lg font-medium max-w-2xl mx-auto leading-relaxed drop-shadow-sm">
                {t("banner_desc")}
              </p>
              <div className="pt-4">
                <button
                  onClick={handleStartScan}
                  className="w-full sm:w-auto px-12 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-black uppercase tracking-widest shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 rounded-xl"
                >
                  {t("btn_get_started")}
                </button>
              </div>
      ...
      {/* 2. THE MARKET TOOLS - Ultra Compact */}
      <section id="features" className="w-full responsive-container py-3 sm:py-4 md:py-6 scroll-mt-20">
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 items-center">
           ...
           >
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[10px] sm:text-xs font-black text-emerald-500 tracking-[0.5em] uppercase">
                 <Globe2 size={12} className="sm:w-3 sm:h-3" /> LIVE DATA
              </div>
              <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-black text-slate-900 dark:text-white tracking-tighter leading-[0.9] sm:leading-none">
                Smarter <span className="text-emerald-600 underline decoration-emerald-500/20 underline-offset-2 sm:underline-offset-4 italic">Data.</span> <br /> 
                <span className="text-slate-400 dark:text-gray-700">Faster Launch.</span>
              </h2>
              <p className="text-slate-500 dark:text-gray-500 text-xs sm:text-sm md:text-base font-medium leading-relaxed">Most people guess. We give you a plan. TrendAI looks at what people are searching for in your city to find what's missing.</p>
        ...
        >
          ...
          <img
            src="/analysis.png"
            alt="Market Results"
            className="compact-img relative border border-slate-200/50 dark:border-slate-700/50 shadow-2xl transform -rotate-2 hover:rotate-0 transition-transform duration-500 w-full backdrop-blur-sm"
          />
          {/* Overlay Stat Card - Compact */}
          <div className="absolute -bottom-3 -left-3 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl compact-p-4 compact-space-y-2 border border-emerald-500/30 dark:border-emerald-500/20 rounded-xl shadow-xl">
            <div className="compact-text-xs font-black text-emerald-600 dark:text-emerald-400 tracking-[0.3em] uppercase">City: New York</div>
            <div className="compact-text-xl font-black text-slate-900 dark:text-white tracking-tighter">High Profit Chance</div>
      ...
      <div className="responsive-container grid md:grid-cols-2 compact-gap-6 items-center">
        ...
        >
          <img
            src="/roadmap.png"
            alt="Business Plan"
            className="compact-img border border-slate-200/50 dark:border-slate-700/50 shadow-2xl w-full backdrop-blur-sm"
          />
        </motion.div>
        ...
        <div className="order-1 md:order-2 compact-space-y-4">
          <div className="inline-flex items-center compact-gap-2 compact-p-3 rounded-full bg-amber-500/15 dark:bg-amber-500/10 border border-amber-500/30 dark:border-amber-500/20 compact-text-xs font-black text-amber-600 dark:text-amber-400 tracking-[0.3em] uppercase shadow-lg">
            <Cpu size={12} /> {t("road_readiness").toUpperCase()}
          </div>
          <h2 className="compact-text-3xl sm:compact-text-4xl font-black text-slate-900 dark:text-white tracking-tighter leading-[0.85] drop-shadow-sm">
            {t("feat_3_title").split(" ")[0]} <span className="text-amber-600 dark:text-amber-400 italic">{t("feat_3_title").split(" ").slice(1).join(" ")}</span> <br />
            <span className="text-slate-500 dark:text-slate-400">{t("road_milestones")}</span>
          </h2>
          <p className="text-slate-600 dark:text-slate-300 compact-text-base font-medium leading-relaxed drop-shadow-sm">{t("feat_3_desc")}</p>

          <ul className="compact-space-y-4 relative">
            {[
              { title: t("dash_market_gap"), desc: t("feat_1_desc"), delay: 0.1 },
              { title: t("dash_profit_pred"), desc: t("feat_2_desc"), delay: 0.2 },
              { title: t("road_action"), desc: t("feat_3_desc"), delay: 0.3 }
            ].map((item, idx) => (
              <motion.li
                key={idx}
    ...
    < section id = "showcase" className = "w-full responsive-container ultra-compact-section scroll-mt-20" >
        ...
        >
          <div className="inline-flex items-center compact-gap-2 compact-p-3 rounded-full bg-blue-500/15 dark:bg-blue-500/10 border border-blue-500/30 dark:border-blue-500/20 compact-text-xs font-black text-blue-600 dark:text-blue-400 tracking-[0.3em] uppercase shadow-lg">
            <Zap size={12} /> {t("nav_analytics_view").toUpperCase()}
          </div>
          <h2 className="compact-text-3xl sm:compact-text-4xl font-black text-slate-900 dark:text-white tracking-tighter leading-[0.85] drop-shadow-sm">
            {t("feat_title")} <br /> 
            <span className="text-blue-600 dark:text-blue-400 italic">{t("road_milestones")}.</span>
          </h2>
        ...
        >
          {[
            ...
            const featureKeys = [
              ...
              { title: t("dash_ai_insights"), desc: t("dash_ai_desc") },
              { title: t("road_action"), desc: t("feat_3_desc") },
              { title: t("dash_mentors"), desc: t("dash_mentor_desc") },
              { title: t("dash_profit_pred"), desc: t("dash_roi_calc") },
              { title: t("dash_realtime"), desc: t("dash_live_intel") }
            ];
            return (
            <motion.div
              key={idx}
    ...
    < section id = "testimonials" className = "w-full bg-slate-100/80 dark:bg-slate-900/50 ultra-compact-section border-y border-slate-200/80 dark:border-slate-700/50 transition-colors duration-500 scroll-mt-20 backdrop-blur-sm" >
      <div className="responsive-container">
        ...
        >
          ...
          <h2 className="compact-text-3xl sm:compact-text-4xl font-black text-slate-900 dark:text-white tracking-tighter leading-[0.85] drop-shadow-sm">
            {t("home_trusted").split(" ")[0]} <span className="text-purple-600 dark:text-purple-400 italic">{t("home_trusted").split(" ").slice(1).join(" ")}</span> <br />
            <span className="text-slate-500 dark:text-slate-400">{t("road_milestones")}</span>
          </h2>
        </motion.div>
            ...
            {[
              {
                ...
                location: t("auth_stat_1_label"),
                quote: t("testimonial_1"),
                revenue: t("auth_stat_2_val"),
              ...
              },
              {
                ...
                location: t("auth_stat_2_label"),
                quote: t("testimonial_2"),
                revenue: t("auth_stat_3_val"),
              ...
              },
              {
                ...
                location: t("auth_stat_3_label"),
                quote: t("testimonial_3"),
                revenue: t("auth_stat_1_val"),
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-0 left-0 p-3 rounded-xl bg-white/10 dark:bg-white/5 border border-slate-300/20 dark:border-white/10 backdrop-blur-xl group cursor-pointer"
      >
        <motion.div
          initial={{ scale: 0 }}
          whileInView={{ scale: 1 }}
      ...
      <motion.div
        ...
        className="absolute top-0 right-0 p-3 rounded-xl bg-white/10 dark:bg-white/5 border border-slate-300/20 dark:border-white/10 backdrop-blur-xl group cursor-pointer"
      >
        <motion.div
          initial={{ scale: 0 }}
          whileInView={{ scale: 1 }}
