      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="p-6 border-b border-white/5 bg-slate-950/50 flex items-center justify-between backdrop-blur-md">
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2.5 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-[11px] font-black uppercase tracking-widest transition-all border border-blue-400/30 shadow-[0_20px_40px_-5px_rgba(37,99,235,0.4)] group"
              >
          ...
          <div className="flex-1 overflow-y-auto bg-slate-100 p-4 md:p-8 custom-scrollbar">
            <div 
              className="mx-auto bg-white shadow-2xl overflow-hidden printable-area" 
