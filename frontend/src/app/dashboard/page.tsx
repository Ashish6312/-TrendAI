            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3 pt-4">
                  {[
                    { label: "Live Market Data", active: true },
                    { label: "AI Predictions", active: false },
                    { label: "Smart Insights", active: false }
                  ].map((pill, idx) => (
                    <div 
                      key={idx}
                      className={`flex items-center gap-2 px-5 py-2.5 rounded-full border text-xs font-black uppercase tracking-widest transition-all duration-300 ${
                        pill.active 
                        ? 'bg-blue-500/10 border-blue-500/20 text-blue-600 dark:text-blue-400' 
                        : 'bg-slate-100 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-500 dark:text-gray-500'
                      }`}
                    >
                      <div className={`w-2 h-2 rounded-full ${pill.active ? 'bg-blue-500 animate-pulse' : 'bg-slate-300 dark:bg-gray-600'}`} />
                      {pill.label}
                    </div>
                  ))}
                </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <Link 
                          href={`/roadmap?area=${encodeURIComponent(area)}&title=${encodeURIComponent(result.recommendations?.[0]?.title || "New Business")}&desc=${encodeURIComponent(result.analysis?.executive_summary || "Market Opportunity")}&lang=${language}`} 
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                      <UniformCard 
                        ...
                        className="shadow-lg border-2 border-slate-200/50 dark:border-white/10"
                      >
                        <p className="text-lg font-medium text-slate-700 dark:text-gray-300 leading-relaxed italic">
                      ...
                      >
                        <div className="grid grid-cols-2 gap-8">
                          <div className="text-center">
                            <div className="text-sm font-bold text-slate-500 dark:text-gray-500 uppercase tracking-wider mb-3">Success Rate</div>
                            <div className="text-4xl font-black text-emerald-500 tracking-tight">{result.analysis?.confidence_score || "85%"}</div>
                          </div>
                          <div className="text-center">
                            <div className="text-sm font-bold text-slate-500 dark:text-gray-500 uppercase tracking-wider mb-3">Market Gap</div>
                            <div className="text-4xl font-black text-blue-500 tracking-tight">{result.analysis?.market_gap_intensity || "High"}</div>
                          </div>
                        </div>
                      </UniformCard>
                    </div>
                      ...
                      <div className="relative z-20 h-full flex flex-col items-center justify-center text-center p-8">
                        ...
                        >
                          ...
                          <div className="flex flex-wrap justify-center gap-4 text-sm">
                            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 backdrop-blur-sm">
                            ...
                            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-sm">
                              <div className="w-2 h-2 bg-slate-500 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
