                ...
                >
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
                      ...
                      <div className="p-6 rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/5 flex flex-col items-center justify-center text-center shadow-md">
                        <div className="w-12 h-12 rounded-full bg-slate-200 dark:bg-slate-800 flex items-center justify-center mb-4">
                          <CreditCard size={24} className="text-slate-500 dark:text-slate-400" />
                        </div>
                        <h4 className="text-sm font-black text-slate-900 dark:text-white mb-1 italic">Secure Payments</h4>
                        <p className="text-[10px] uppercase font-black tracking-widest text-slate-400 dark:text-slate-500 mb-4">Transactions processed via encrypted gateway</p>
                        <button className="w-full py-2 bg-slate-200 dark:bg-white/5 rounded-lg text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all font-black italic">Update Method</button>
                      </div>
                    </div>
