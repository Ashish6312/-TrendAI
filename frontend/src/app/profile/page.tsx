...
import { 
  ...
  Target, Sparkles, ChevronRight, Edit3,
  CreditCard, X
} from "lucide-react";
      ...
      <div className="relative z-10 responsive-container py-6 md:py-8">
        ...
        >
          <div className="flex items-center gap-4">
            <button 
              onClick={() => router.back()} 
              className="flex items-center gap-2 lg:gap-3 px-4 lg:px-6 py-2 lg:py-3 rounded-xl lg:rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 text-gray-400 hover:text-white transition-all group backdrop-blur-sm text-sm lg:text-base"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          >
            ...
            >
              ...
              <div className="relative mb-4 lg:mb-6">
                ...
                <div className="relative">
                  <img 
                    ...
                    className="w-24 h-24 lg:w-32 lg:h-32 rounded-full border-4 border-white/20 shadow-2xl object-cover mx-auto relative z-10"
                    alt="Profile"
                  />
                  <motion.div 
                    className="absolute -bottom-1 -right-1 lg:-bottom-2 lg:-right-2 p-2 lg:p-3 rounded-full shadow-xl border-2 lg:border-4 border-slate-800"
                    style={{ backgroundColor: theme.primary }}
              ...
              >
                ...
                <p className="text-gray-400 text-xs lg:text-sm mb-3 lg:mb-4 break-all px-2">{session?.user?.email}</p>
                
                {formData.company && (
                  <motion.div 
                    initial={{ opacity: 0, scale: 0.8 }}
                    animate={{ opacity: 1, scale: 1 }}
                    className="flex items-center justify-center gap-2 text-xs lg:text-sm text-gray-300 mb-2"
                  >
                    <Building2 size={12} className="lg:w-3.5 lg:h-3.5" />
                    <span className="truncate px-2">{formData.company}</span>
                  </motion.div>
                )}
                ...
                {(formData.location || userLocation?.country !== 'Unknown') && (
                  ...
                  >
                    ...
                    <span className="truncate px-2">{formData.location || `${userLocation?.city}, ${userLocation?.country}`}</span>
                  </motion.div>
                )}

                {joinDate && (
                  <div className="flex items-center justify-center gap-2 text-xs lg:text-sm text-gray-400 mb-3 lg:mb-4">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs lg:text-sm font-semibold text-gray-300">Profile Completion</span>
                  <span className="text-xs lg:text-sm font-bold" style={{ color: theme.primary }}>
                    {completionPercentage()}%
                  </span>
                </div>
                <div className="w-full bg-gray-700 rounded-full h-1.5 lg:h-2 overflow-hidden">
                  <motion.div 
              ...
              >
                <div className="text-center p-3 lg:p-4 bg-white/5 rounded-xl border border-white/10">
                  ...
                  <div className="text-xs text-gray-400 uppercase tracking-wider">Analyses</div>
                </div>
                <div className="text-center p-3 lg:p-4 bg-white/5 rounded-xl border border-white/10">
                  <motion.div 
                  ...
                  <div className="text-xs text-gray-400 uppercase tracking-wider">Limit</div>
                </div>
              </motion.div>
          ...
          >
            {/* Tab Navigation */}
            <div className="flex flex-col sm:flex-row space-y-1 sm:space-y-0 sm:space-x-1 mb-6 lg:mb-8 p-1 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              {[
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-4 lg:px-6 py-3 lg:py-4 rounded-xl font-semibold text-xs sm:text-sm transition-all ${
                    activeTab === tab.id
              ...
              {activeTab === 'overview' && (
                ...
                >
                  ...
                  <motion.div 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="glass-card p-10 bg-gradient-to-br from-emerald-500/10 via-slate-900/95 to-slate-900 overflow-hidden relative border-emerald-500/20"
                  >
                      ...
                      <div className="flex flex-col lg:flex-row items-center gap-12">
                        ...
                        <div className="relative shrink-0">
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <span className="text-5xl font-black text-white italic tracking-tighter">{completionPercentage()}%</span>
                            <span className="text-[9px] font-black text-emerald-500/50 uppercase tracking-[0.3em] mt-1">Readiness</span>
                          </div>
                        </div>

                        <div className="flex-1 space-y-10 text-center lg:text-left">
                          <div className="space-y-4">
                            <h3 className="text-3xl font-black text-white italic tracking-tighter leading-tight">Strategic Authority Protocol</h3>
                            <p className="text-slate-400 text-sm font-medium leading-relaxed max-w-xl">
                              Your profile readiness determines your influence within the regional market ecosystem. Complete your dossier to unlock elite analytical tools.
                            </p>
                          </div>

                          {/* Status Badges - High Engagement */}
                          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
                             <div className={`px-5 py-2.5 rounded-2xl border flex items-center gap-3 transition-all duration-500 ${completionPercentage() > 80 ? 'bg-emerald-500/20 border-emerald-500/30 text-emerald-400 shadow-xl' : 'bg-white/5 border-white/10 text-slate-500'}`}>
                                <Award size={18} />
                                <span className="text-[10px] font-black uppercase tracking-widest">{completionPercentage() > 80 ? 'Elite Strategist' : 'Emerging Founder'}</span>
                             </div>
                             <div className={`px-5 py-2.5 rounded-2xl border flex items-center gap-3 transition-all duration-500 group relative ${formData.location ? 'bg-blue-500/20 border-blue-500/30 text-blue-400 shadow-xl' : 'bg-white/5 border-white/10 text-slate-500'}`}>
                                <Globe size={18} className={`${formData.location ? 'animate-pulse' : ''}`} />
                                <span className="text-[10px] font-black uppercase tracking-widest">{formData.location ? `Dominating ${formData.location.split(',')[0]}` : 'Unanchored Signal'}</span>
                             </div>
                             <div className="px-5 py-2.5 rounded-2xl bg-purple-500/10 border border-purple-500/20 text-purple-400 flex items-center gap-3">
                                <Target size={18} />
                                <span className="text-[10px] font-black uppercase tracking-widest">Rank: Top 12%</span>
                             </div>
                          </div>

                          {/* Critical Actions */}
                          <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center gap-6">
                             <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Tactical Suggestions:</span>
                             <div className="flex gap-4">
                                {completionPercentage() < 100 && (
                                  ...
                                  >
                                     Complete Intel <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
                                  </button>
                                )}
                                <button 
                                ...
                                >
                                   Execute Scan <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
                                </button>
                             </div>
                          </div>
                        </div>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold text-white">Plan Overview</h2>
                        <p className="text-gray-400">Your current subscription and features</p>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                            <div className="flex items-center justify-between mb-2">
                              <span className="text-sm text-gray-300">Market Analyses</span>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-opacity-50 transition-all"
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-12 pr-24 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-opacity-50 transition-all"
                              style={{ '--tw-ring-color': theme.primary } as React.CSSProperties}
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <select
                              ...
                              className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-opacity-50 transition-all appearance-none cursor-pointer"
                              style={{ '--tw-ring-color': theme.primary } as React.CSSProperties}
                            >
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <textarea
                            ...
                            rows={4}
                            className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-opacity-50 transition-all resize-none"
                            style={{ '--tw-ring-color': theme.primary } as React.CSSProperties}
                ...
                >
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-sm">Review your subscription, usage, and transaction history</p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
                      {/* Plan Card */}
                      <div className="lg:col-span-2 p-6 rounded-2xl bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-white/5 relative overflow-hidden group">
                        <div 
                        ...
                        <div className="relative z-10">
                          <div className="flex items-start justify-between mb-6">
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                {subscriptionDetails?.status === 'active' && (
                                  <span className="px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 text-[8px] font-bold uppercase tracking-tighter border border-emerald-500/20">Active</span>
                                )}
                              </div>
                              <h3 className="text-3xl font-black text-white tracking-tight">{planFeatures.planName}</h3>
                            </div>
                            <div className="text-right">
                              ...
                              <div className="text-2xl font-black text-white">
                                ...
                                <span className="text-xs text-slate-400 font-medium ml-1">/ {subscriptionDetails?.billing_cycle || 'Cycle'}</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-white/5">
                            <div>
                              <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block mb-1">Renews on</span>
                              <span className="text-sm font-bold text-slate-200">
                                {subscriptionDetails?.subscription_end ? new Date(subscriptionDetails.subscription_end).toLocaleDateString() : 'N/A'}
                              </span>
                            </div>
                            <div>
                              <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block mb-1">Cycle</span>
                              <span className="text-sm font-bold text-slate-200 capitalize">
                                {subscriptionDetails?.billing_cycle || 'Monthly'}
                              </span>
                            </div>
                            <div>
                              <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block mb-1">Analyses</span>
                              <span className="text-sm font-bold text-slate-200">
                                {analysisCount} / {planFeatures.maxAnalyses === -1 ? '∞' : planFeatures.maxAnalyses}
                              </span>
                            </div>
                      ...
                      <div className="p-6 rounded-2xl bg-white/5 border border-white/5 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-xs text-slate-500 mb-4">Transactions processed via encrypted gateway</p>
                        <button className="w-full py-2 bg-white/5 rounded-lg text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-white transition-all">Update Method</button>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      {payments.length > 0 ? (
                          ...
                          <table className="w-full text-left">
                            <thead>
                              <tr className="border-b border-white/5">
                                <th className="pb-4 text-[10px] font-black uppercase tracking-widest text-slate-500">Invoice ID</th>
                                <th className="pb-4 text-[10px] font-black uppercase tracking-widest text-slate-500">Date</th>
                                <th className="pb-4 text-[10px] font-black uppercase tracking-widest text-slate-500">Plan</th>
                                ...
                                <th className="pb-4 text-right text-[10px] font-black uppercase tracking-widest text-slate-500">Action</th>
                              </tr>
                            </thead>
                            <tbody className="divide-y divide-white/5">
                              {payments.map((payment: any) => (
                                <tr key={payment.id} className="group hover:bg-white/5 transition-colors">
                                  <td className="py-4 font-mono text-xs text-slate-300">{payment.razorpay_payment_id?.slice(0, 12)}...</td>
                                  <td className="py-4 text-xs text-slate-400">{new Date(payment.payment_date).toLocaleDateString()}</td>
                                  <td className="py-4">
                                    <div className="flex items-center gap-2">
                                      <span className="text-xs font-black text-white italic">{getProfessionalPlanName(payment.plan_name)}</span>
                                      <span className="text-[8px] font-black uppercase tracking-tighter text-slate-500 border border-slate-700/50 rounded-md px-1.5 py-0.5 bg-slate-800/50">{payment.billing_cycle}</span>
                                    </div>
                                  </td>
                                  <td className="py-4 text-xs font-black text-white tracking-tight">
                                    <span className="text-blue-400 font-black mr-1">{payment.currency === 'INR' ? '₹' : '$'}</span>
                                  ...
                                  <td className="py-4 text-right">
                                    <button 
                                      ...
                                      className="p-2 rounded-lg bg-white/5 text-slate-400 hover:text-white hover:bg-white/10 transition-all flex items-center gap-2"
                                      title="View Professional Invoice"
                                    >
                                      <FileText size={14} />
                                      <span className="text-[10px] font-bold uppercase tracking-widest hidden sm:inline">Receipt</span>
                                    </button>
                                  </td>
                                </tr>
                              ))}
                        ...
                        <div className="text-center py-12 bg-white/5 rounded-2xl border border-dashed border-white/10">
                          <CreditCard size={40} className="mx-auto mb-4 text-slate-600 opacity-20" />
                          <p className="text-sm font-bold text-slate-400">No transactions recorded yet</p>
                          <p className="text-xs text-slate-600 mt-1">Upgrade your plan to see your billing history here</p>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="glass-card p-6 lg:p-8" style={{ borderColor: `${theme.primary}10` }}>
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-lg font-bold text-white flex items-center gap-2">
